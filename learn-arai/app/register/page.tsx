          ...
          <div className="input-form">
            <form onSubmit={(e) => submitHandle(e)} className="flex flex-col gap-2 ">
              <div className='flex flex-row gap-4'>
                <Input htmlFor='name' label='Name' type='text' placeholder='Name' name='name' isRequied={true}>
                  <FaRegUser className='icon-in-input-field' />
                </Input>
                <Input htmlFor='surname' label='Surname' type='text' placeholder='Surname' name='Surname' isRequied={true}>
                  <FaRegUser className='icon-in-input-field' />
                </Input>
              </div>
              <Input htmlFor='Phone' label='Phone' type='text' placeholder='Phone' name='Phone' isRequied={true}>
                <FaPhoneAlt className='icon-in-input-field' />
              </Input>
              <Input htmlFor='Email' label='Email' type='text' placeholder='Email' name='email' isRequied={true}>
                <MdOutlineEmail className='icon-in-input-field' />
              </Input>
              <Input htmlFor='Password' label='Password' type='Password' placeholder='Password' name='password' isRequied={true}>
                <IoMdKey className='icon-in-input-field' />
              </Input>
              <Input htmlFor='Confirm Password' label='Confirm Password' type='Password' placeholder='Confirm Password' name='password-confirmation' isRequied={true}>
                <IoMdKey className='icon-in-input-field' />
              </Input>
